"""
Django settings for midtermprojectPBP_F03 project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-0zmpas1#!-u4x@3sn1di!99@^x_dny-8mme)3b1j2ban_qlbh(')
...
ROOT_URLCONF = 'midtermprojectPBP_F03.urls'
...
WSGI_APPLICATION = 'midtermprojectPBP_F03.wsgi.application'
